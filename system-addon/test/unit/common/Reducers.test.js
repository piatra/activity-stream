...
describe("Reducers", () => {
  ...
  describe("TopSites", () => {
    ...
    it("should set screenshotRequestFailed to false on SCREENSHOT_UPDATED", () => {
      ...
      const action = {type: at.SCREENSHOT_PREVIEW, data: {url: "bar.com", screenshotPreview: "data:123"}};
    ...
    it("should add screenshotPreview on SCREENSHOT_UPDATED", () => {
      ...
      const action = {type: at.SCREENSHOT_PREVIEW, data: {url: "bar.com", screenshotPreview: "data:123"}};
      const nextState = TopSites(oldState, action);
      assert.deepEqual(nextState.rows, [{url: "foo.com"}, {url: "bar.com", screenshotPreview: "data:123"}]);
    });
