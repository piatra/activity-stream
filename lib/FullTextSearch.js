...
FullTextSearchStore.prototype = {
  ...
  asyncSearchGeneric: Task.async(function*(keywords) {
    let results = yield Promise.all([
      this.asyncSearchPagesExact(keywords),
      this.asyncSearchBookmarks(keywords),
      this.asyncSearchHistory(keywords, 50),
      this.asyncSearchTabs(keywords)
    ]);
    return {
      "pages": results[0],
      "bookmarks": results[1],
