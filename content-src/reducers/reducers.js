...
const setFilteredActivity = require("reducers/setFilteredActivity");
...
module.exports = {
  ...
  History: setRowsOrError("RECENT_LINKS_REQUEST", "RECENT_LINKS_RESPONSE", "FILTER_REQUEST", "FILTER_RESPONSE"),
  ...
  FilteredActivity: setFilteredActivity(),
  Experiments
};
